    ...
    >
      <div className="space-y-10">
        <div className="flex items-center justify-center">
          <Link href="/dashboard" className={cn("relative transition-all duration-300 ease-in-out block", collapsed ? "w-16 h-16" : "w-full h-28")}>
            <NextImage
              src={collapsed ? "/Images/LOGO-LIME-Inicial.png" : "/Images/Logo-LIME-NoFondo.png"}
              alt="LIME EquipManage"
              fill
      ...
      {!collapsed && (
        <div className="border-t border-slate-100 p-4 bg-slate-50/50">
          <div className="space-y-3 text-center">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-400">Desarrollado por</p>

            <div className="space-y-2">
              <p className="text-sm font-medium text-slate-700">Juan Pablo Restrepo</p>
              <div className="flex justify-center">
                <a
                  href="https://github.com/JPDevOpti"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-1.5 rounded-md border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-500 shadow-sm transition-all hover:border-slate-300 hover:text-slate-900"
                >
